...
<html>
    <head>
        <title>Courses Grades - Administrator</title>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <fieldset>
            <h1 style="text-align:center" >Courses Grades - Administrator</h1> 

            <div id="apDiv2" > 
                <table width="737" border="1" > 
                    <tr> 
                        <td><a href="Student" target="Main">Create new student</a></td>  
                        <td><a href="Course" target="Main">Create new course</a>                       
                    ...
                    <h3 style="text-align:right"><span style="color:blue">Welcome <a href="#">${nUser}</a></span>&nbsp;&nbsp;&nbsp;
                        <span style="color:red"><a href="index">Logout</a></span><br></h3>
                    <h3> <mm:currentDate/></h3>
                    </tr> 
                </table> 
                <iframe src="Student" name="Main" width="1000" height="509" style="stylesheet"></iframe> 
            </div> 
        </fieldset>
